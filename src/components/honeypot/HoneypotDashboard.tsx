...
export const HoneypotDashboard: React.FC = () => {
  const [selectedLog, setSelectedLog] = useState<HoneypotLog>(honeypotLogs[0]);
    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-cyan-300 bg-cyan-950/30 border border-cyan-500/30 px-3 py-2 rounded-xl">
          ...
          <span>ZERO REAL USER DATA INGESTED</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 rounded-xl bg-slate-900/80 border border-cyan-500/25 backdrop-blur-md">
          ...
          <div className="text-3xl font-extrabold font-mono text-cyan-400">
            {honeypotOverviewMetrics.messagesCaptured.toLocaleString()}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-white font-mono uppercase">
                LIVE INTERCEPTED DECOY STREAMS
              </h3>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between text-xs font-mono">
                    ...
                    <RiskBadge level={log.urgencyLevel} size="sm" />
                  </div>
        ...
        <div className="lg:col-span-6 rounded-2xl bg-slate-900/90 border border-cyan-500/30 p-6 backdrop-blur-xl shadow-2xl space-y-5">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            ...
            <RiskBadge level={selectedLog.urgencyLevel} size="md" />
          </div>

          <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-2">
            <span className="text-[10px] font-mono uppercase tracking-wider text-slate-400 block">
              Intercepted Bait Message:
            </span>
          ...
          <div className="space-y-3 font-mono text-xs">
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
              ...
              <div className="space-y-1">
                {selectedLog.extractedIndicators.domains.length > 0 ? (
            ...
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
              ...
              <div className="space-y-1">
                {selectedLog.extractedIndicators.paymentIds.length > 0 ? (
            ...
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
              ...
              <div className="space-y-1">
                {selectedLog.extractedIndicators.phoneNumbers.length > 0 ? (
