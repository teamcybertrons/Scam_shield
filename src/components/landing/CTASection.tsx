...
import { Search, ShieldCheck, ArrowRight, MessageSquare } from 'lucide-react';
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="rounded-3xl bg-gradient-to-b from-cyan-950/40 via-slate-900/90 to-[#060a16] border border-cyan-500/30 p-8 sm:p-14 text-center backdrop-blur-2xl shadow-2xl relative overflow-hidden">
